  ...
  en: {
    translation: {
      ...
      commands: {
        ...
        aiNameCollisionHelp: "Ask AI to propose another command name, then save again.",
        ...
        memberDefaultPlaceholder: "Default executor: {{member}}",
        ...
        authoring: {
          title: "AI assistant",
          empty: "Describe what this command should do, or ask for a change to the current draft.",
          thinking: "Working on the draft…",
          inputLabel: "Message to AI assistant",
          placeholder: "What should this command do?",
          send: "Send",
          trace: "Trace: {{traceId}}",
          errorTitle: "The AI assistant could not update the draft",
        },
        newDraftOption: "{{command}} — {{format}} (unsaved AI draft)",
        proposedByAi: "Format proposed by AI",
  ...
  ja: {
    translation: {
      ...
      commands: {
        ...
        aiNameCollisionHelp: "AIに別のコマンド名を提案させてから、もう一度保存してください。",
        ...
        memberDefaultPlaceholder: "既定の実行者: {{member}}",
        extraArgs: "追加引数",
        ...
        authoring: {
          title: "AIアシスタント",
          empty: "このコマンドで実現したいこと、または現在のドラフトへの変更を入力してください。",
          thinking: "ドラフトを作成しています…",
          inputLabel: "AIアシスタントへのメッセージ",
          placeholder: "このコマンドで何を実現しますか?",
          send: "送信",
          trace: "トレース: {{traceId}}",
          errorTitle: "AIアシスタントがドラフトを更新できませんでした",
        },
        newDraftOption: "{{command}} — {{format}}（未保存のAIドラフト）",
        proposedByAi: "AIが提案した形式",
        createTitle: "新規作成",
