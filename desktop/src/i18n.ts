  ...
  en: {
    translation: {
      decision: {
        ...
        member: "Overrides the team judgment engine for this member.",
      ...
      diagnostics: {
        ...
        troubleshooting: {
          ...
          open: "Ask AI",
          openForTrace: "Ask AI about this error",
          openForRecord: "Ask AI about this record",
          empty:
            "Ask about a failure and the assistant reads the recorded diagnostics to explain it.",
          thinking: "Investigating the diagnostics…",
          inputLabel: "Message to troubleshooting AI",
          placeholder: "Why did this execution fail?",
          send: "Send",
          trace: "Trace: {{traceId}}",
          errorTitle: "The troubleshooting AI could not answer",
          ...
          privacyTitle: "Diagnostics are sent to the AI provider",
          privacyBody:
            "The assistant reads recorded logs, prompts and command output, and sends what it reads to the configured AI provider.",
        ...
        executions: {
          ...
          transcriptDeleted: "The transcript was deleted by the retention policy.",
          ...
          eventTypes: {
            ...
            event_listener: "Event listener",
            scheduler_worker_failed: "Worker failed",
          ...
          messages: {
            ...
            scheduler_running: "Member workers started.",
            scheduler_stopping: "Member workers are stopping.",
            scheduler_stopped: "Member workers stopped.",
            scheduler_failed: "Member workers failed.",
            events_starting: "The event listener is starting.",
            events_running: "The event listener started.",
            events_stopping: "The event listener is stopping.",
            events_stopped: "The event listener stopped.",
            events_failed: "The event listener failed.",
            ...
            workflow_rate_limited: "Rate limited until {{retry_at}}.",
          ...
          ioTypes: {
            ...
            cli_agent_request: "CLI request",
            cli_agent_response: "CLI response",
          },
          spanEvents: {
      ...
      setup: {
        ...
        intelligence: {
          ...
          environment: {
            ...
            toolCredentialsSaved: "Credentials saved on this device",
            toolAuthenticationFailed: "Authentication failed. Log in again.",
            refresh: "Refresh display",
            recheck: "Check again",
            usageFailed: "Usage check failed",
            usageSucceeded: "Usage check succeeded",
            usageChecking: "Checking usage…",
            lastChecked: "Last checked: {{time}}",
            errorDetails: "Error details",
            recheckError:
              "Could not complete the check. The previous result is still shown. Try again.",
            toolCredentialsMissing: "No credentials saved on this device",
            loginHint: "To log in or log in again, run this command in a terminal:",
            loginRecheckHint: "After logging in, use Check again to verify usage retrieval.",
            copy: "Copy",
            copied: "Copied",
          ...
          effort: {
            ...
            inherited: "Inherited",
            customize: "Customize",
            showJson: "Edit as JSON",
            showFields: "Back to fields",
            unsupported: "This tool cannot apply effort settings.",
            modelLevelLabel: "Use a different model",
            modelAlwaysLabel: "Model",
            emptyIsToolDefault: "The tool\u2019s own default",
            emptyChangesNothing: "Unchanged",
            levelHint: "Applied only at this level.",
          ...
          effortJson: "Effort settings (JSON)",
        ...
        members: {
          ...
          defaultPersonDescription: "Runs commands that do not name a member.",
          defaultPersonPlaceholder: "Select a member",
          defaultPersonError: "Failed to save the default executor",
          addTitle: "Add member",
          ...
          patrol: {
            ...
            routineIneligible: "Cannot run on a schedule because it requires caller input.",
            noRoutineCommands:
      ...
      commands: {
        ...
        newFile: "New command",
        deleteFile: "Delete",
        deleteConfirmTitle: "Delete this command?",
        deleteConfirmBody:
          "'{{command}}' and its file are removed from the workspace. This cannot be undone.",
        deleteCancel: "Cancel",
        deleteErrorTitle: "Could not delete",
        deleteConflictBody:
          "This command file changed on disk since it was loaded. Reload it and check the latest version before deleting.",
        save: "Save",
        ...
        conflictBody:
          "This command file changed on disk since it was loaded. Reload the latest version or keep editing.",
        conflictReload: "Reload latest",
        conflictKeep: "Keep editing",
        emptyTitle: "No commands yet",
        emptyBody: "There are no shared commands yet. Create one to get started.",
        verifyHeading: "Try this command",
        resizeEditor: "Resize editor",
        saveAndRun: "Save and run",
        runBlockedTitle: "Cannot run this command",
        runner: "Run as {{member}} — click to change",
        extraArgs: "Additional args",
        extraArgsPlaceholder: 'arg1 key=value "quoted value"',
        message: "Input text",
        messageDescription:
        ...
        openScript: "Open in external editor",
        ...
        authoring: {
          ...
          send: "Send",
          trace: "Trace: {{traceId}}",
          errorTitle: "The AI assistant could not respond",
          runner: "AI assistant: {{member}} — click to change",
        },
        authoringProposal: {
          ready: "A change proposal is ready. Review each file tab.",
          reviewRegion: "Proposed command changes",
          current: "Current",
          operations: {
            create: "Create",
            update: "Update",
          },
          sourceLabel: "Source of {{path}}",
          diffLabel: "Changes to {{path}}",
          applyHelp: "Review every displayed file before applying the changes together.",
          applyErrorTitle: "Could not apply the proposal",
          discard: "Discard",
          apply: "Apply changes",
          back: "Back",
        },
        createTitle: "New command",
        createMethodLabel: "Creation method",
        createMethodAi: "Create with AI",
        createMethodManual: "Create myself",
        createAiRequestLabel: "What should this command do?",
        createAiRequestHelp: "AI will propose the command name, format, and complete source.",
        createAiRequestPlaceholder: "Describe the behavior, inputs, output, and any constraints.",
        createAiSubmit: "Ask AI to create",
        createNameLabel: "Command name",
        createNameHelp: "Use letters, digits and hyphens; '/' makes a nested command.",
        createFormatLabel: "Format",
        createErrorTitle: "Could not create",
        createCancel: "Cancel",
        createSubmit: "Create",
        formats: {
        ...
        unsavedBody: "You have unsaved changes. Save them, discard them, or cancel.",
        unsavedSave: "Save",
        unsavedDiscard: "Discard",
        unsavedCancel: "Cancel",
        shadow: {
          member:
            "A member-specific command takes priority, so this shared command cannot be tested for this member.",
          template:
            "A localized built-in command takes priority, so this command cannot be tested.",
          workspace:
            "A higher-priority shared command runs instead, so this command cannot be tested.",
          generic: "The edited file is not the command that would actually run.",
        },
        errors: {
          command_file_invalid_name: "That command name is not allowed.",
          command_file_invalid_source: "The command source is not valid.",
          command_file_unsupported_format: "That command format is not supported.",
          command_file_not_found: "The command file could not be found.",
          command_file_exists: "A command with that name already exists.",
          command_file_changed: "The command file changed since it was loaded.",
          command_file_shadowed: "The command would be shadowed by a higher-priority file.",
          command_file_too_large: "The command source is too large.",
          command_requirement_missing: "Required setup is missing.",
          person_not_found: "The selected member could not be found.",
        },
        sources: {
          workspace: "Workspace",
          template: "Built-in",
  ...
  ja: {
    translation: {
      decision: {
        ...
        member: "このメンバーの判断エンジンをチーム設定から上書きします。",
      ...
      setup: {
        ...
        intelligence: {
          ...
          environment: {
            ...
            toolCredentialsSaved: "この端末に認証情報保存済み",
            toolAuthenticationFailed: "認証に失敗しました。再ログインしてください。",
            refresh: "表示を更新",
            recheck: "再確認",
            usageFailed: "利用レート取得失敗",
            usageSucceeded: "利用レート確認済み",
            usageChecking: "利用レートを確認中…",
            lastChecked: "最終確認：{{time}}",
            errorDetails: "エラー詳細",
            recheckError:
              "確認を完了できませんでした。前回の結果を表示しています。もう一度お試しください。",
            toolCredentialsMissing: "この端末に認証情報未保存",
            loginHint: "ログイン・再ログインする場合は、ターミナルで次を実行してください。",
            loginRecheckHint:
              "ログイン後に「再確認」を押すと、利用レートを取得できるか確認できます。",
            copy: "コピー",
            copied: "コピーしました",
          ...
          effort: {
            ...
            showJson: "JSONで編集",
            showFields: "項目編集に戻る",
            unsupported: "このツールはエフォート設定を適用できません。",
            modelLevelLabel: "別のモデルを使う",
            modelAlwaysLabel: "モデル",
            emptyIsToolDefault: "ツール自身の既定",
            emptyChangesNothing: "変更しない",
            levelHint: "このレベルのときだけ適用されます。",
            noIntervention: "介入しない",
            level: {
              low: "low",
              high: "high",
            },
          },
          effortJson: "エフォート設定（JSON）",
          effortJsonDescription:
        ...
        members: {
          ...
          defaultPersonDescription: "メンバーを指定せずにコマンドを実行したときに使われます。",
          defaultPersonPlaceholder: "メンバーを選択",
          defaultPersonError: "既定の実行者を保存できませんでした",
          addTitle: "メンバーを追加",
          editTitle: "メンバーを編集",
          type: "メンバー種別",
          ...
          patrol: {
            ...
            routineIneligible: "呼び出し側の入力が必要なため、巡回実行では実行できません。",
      ...
      diagnostics: {
        ...
        troubleshooting: {
          title: "トラブルシューティングAI",
          open: "AIに相談",
          openForTrace: "このエラーをAIに相談",
          openForRecord: "この記録についてAIに聞く",
          empty: "失敗について質問すると、記録された診断ログを調べて原因を説明します。",
          thinking: "診断ログを調査しています…",
          inputLabel: "トラブルシューティングAIへのメッセージ",
          placeholder: "この実行はなぜ失敗しましたか?",
          send: "送信",
          trace: "トレース: {{traceId}}",
          errorTitle: "トラブルシューティングAIが回答できませんでした",
          ...
          privacyTitle: "診断ログがAIプロバイダへ送信されます",
          privacyBody:
            "アシスタントは記録されたログ、プロンプト、コマンド出力を読み取り、その内容を設定済みのAIプロバイダへ送信します。",
          privacyDismiss: "了解",
        ...
        executions: {
          ...
          transcriptDeleted: "トランスクリプトは保持期限により削除済みです。",
          ...
          eventTypes: {
            ...
            scheduler: "メンバーワーカー",
            event_listener: "イベント起動",
            scheduler_worker_failed: "ワーカー失敗",
            github_push: "GitHub Push",
            github_pull_request: "Pull Request",
            github_issue: "Issue",
          ...
          messages: {
            ...
            scheduler_running: "メンバーワーカーを開始しました。",
            scheduler_stopping: "メンバーワーカーを停止しています。",
            scheduler_stopped: "メンバーワーカーを停止しました。",
            scheduler_failed: "メンバーワーカーが失敗しました。",
            events_starting: "イベント起動を開始しています。",
            events_running: "イベント起動を開始しました。",
            events_stopping: "イベント起動を停止しています。",
            events_stopped: "イベント起動を停止しました。",
            events_failed: "イベント起動が失敗しました。",
            scheduler_worker_failed:
              "{{source}} ワーカーが連続 {{count}} 回失敗しました（上限: {{limit}} 回）。",
            workflow_completed: "Run {{run}} が完了しました（{{attempt}} 回目）。",
            workflow_rate_limited: "{{retry_at}} まで Rate limit 中です。",
            chat_dispatch_retry_scheduled:
            ...
            chat_receive_state_reset:
              "{{members}} 名のメンバー、{{channels}} 個のチャンネルをリセットしました。",
          },
          agentRuntime: {
            process: "プロセス",
            turn: "ターン",
          ...
          eventNames: {
            ...
            initialized: "初期化",
            updated: "更新",
            context_compaction: "コンテキスト圧縮",
          },
          ioTypes: {
            llm_request: "LLM リクエスト",
            llm_response: "LLM レスポンス",
            cli_agent_request: "CLI リクエスト",
            cli_agent_response: "CLI レスポンス",
          },
          spanEvents: {
            finished: "呼び出し完了",
            failed: "呼び出し失敗",
      ...
      commands: {
        ...
        newFile: "新規作成",
        deleteFile: "削除",
        deleteConfirmTitle: "このコマンドを削除しますか?",
        deleteConfirmBody:
          "「{{command}}」のファイルをワークスペースから削除します。元に戻すことはできません。",
        deleteCancel: "キャンセル",
        deleteErrorTitle: "削除できませんでした",
        deleteConflictBody:
          "このコマンドファイルは読み込み後にディスク上で変更されました。最新版を再読み込みして内容を確認してから削除してください。",
        save: "保存",
        ...
        conflictBody:
          "このコマンドファイルは読み込み後にディスク上で変更されました。最新版を再読み込みするか、編集を続けてください。",
        conflictReload: "最新版を再読み込み",
        conflictKeep: "編集を続ける",
        emptyTitle: "コマンドはまだありません",
        emptyBody: "共有コマンドはまだありません。新規作成してください。",
        verifyHeading: "このコマンドを動作確認",
        resizeEditor: "エディタの高さを変更",
        saveAndRun: "保存して実行",
        runBlockedTitle: "このコマンドは実行できません",
        runner: "実行者: {{member}} — クリックで変更",
        extraArgs: "追加引数",
        extraArgsPlaceholder: 'arg1 key=value "引用付きの値"',
        message: "入力文",
        messageDescription:
        ...
        authoring: {
          ...
          placeholder: "このコマンドで何を実現しますか?",
          send: "送信",
          trace: "トレース: {{traceId}}",
          errorTitle: "AIアシスタントが応答できませんでした",
          runner: "AIアシスタント: {{member}} — クリックで変更",
        },
        authoringProposal: {
          ready: "{{count}}件の変更案を作成しました。ファイルタブで確認してください。",
          reviewRegion: "コマンドの変更提案",
          current: "現在",
          operations: {
            create: "新規作成",
            update: "更新",
          },
          sourceLabel: "{{path}} のソース",
          diffLabel: "{{path}} の変更差分",
          applyHelp: "{{count}}件すべてを確認してから、まとめて適用してください。",
          applyErrorTitle: "変更提案を適用できませんでした",
          discard: "破棄",
          apply: "変更を適用",
          back: "戻る",
        },
        createTitle: "新規作成",
        createMethodLabel: "作成方法",
        createMethodAi: "AIに作成させる",
        createMethodManual: "自分で作成する",
        createAiRequestLabel: "このコマンドで何を実現しますか?",
        createAiRequestHelp: "AIがコマンド名、形式、完全なソースを提案します。",
        createAiRequestPlaceholder: "動作、入力、出力、制約などを記述してください。",
        createAiSubmit: "AIに作成を依頼",
        createNameLabel: "コマンド名",
        createNameHelp: "英数字とハイフンを推奨します。'/' でネストしたコマンドになります。",
        createFormatLabel: "形式",
        createErrorTitle: "作成できませんでした",
        createCancel: "キャンセル",
        createSubmit: "作成",
        formats: {
          markdown: "Markdown (.md)",
          python: "Python (.py)",
          shell: "Shell (.sh)",
          yaml: "YAML ワークフロー (.yaml)",
        },
        unsavedTitle: "未保存の変更",
        unsavedBody: "未保存の変更があります。保存、破棄、またはキャンセルを選択してください。",
        unsavedSave: "保存",
        unsavedDiscard: "破棄",
        unsavedCancel: "キャンセル",
        shadow: {
          member:
            "このメンバーでは専用コマンドが優先されるため、編集中の共有コマンドを動作確認できません。",
          template:
            "組み込みコマンドのローカライズ版が優先されるため、編集中のコマンドを動作確認できません。",
          workspace:
            "同名の優先度が高い共有コマンドが実行対象になるため、編集中のコマンドを動作確認できません。",
          generic: "編集中のファイルが通常の実行対象と一致しません。",
        },
        errors: {
          command_file_invalid_name: "そのコマンド名は使用できません。",
          command_file_invalid_source: "コマンドの内容が正しくありません。",
          command_file_unsupported_format: "その形式のコマンドには対応していません。",
          command_file_not_found: "コマンドファイルが見つかりません。",
          command_file_exists: "同名のコマンドが既に存在します。",
          command_file_changed: "読み込み後にコマンドファイルが変更されました。",
          command_file_shadowed: "優先度の高いファイルにより実行対象になりません。",
          command_file_too_large: "コマンドの内容が大きすぎます。",
          command_requirement_missing: "必要な設定が不足しています。",
          person_not_found: "選択したメンバーが見つかりません。",
        },
        sources: {
          workspace: "Workspace",
          template: "組み込み",
