    ...
    translation: {
      ...
      sync: {
        ...
        owner: {
          ...
          hint: "Ownership does not expire. Transfer it only after confirming the old service is stopped.",
          takeOver: "Take over on this machine",
          connection: {
            unknown: "Connection unknown",
            online: "Old owner is online",
            delayed: "Old owner is delayed",
            expired: "Old owner is offline",
          },
          ...
          confirmHint: "Confirm directly that the old service has stopped before continuing.",
          cancel: "Cancel",
  ...
  ja: {
    translation: {
      ...
      sync: {
        ...
        owner: {
          title: "service owner",
          current: "現在の owner: {{name}}（{{deviceId}}）",
          none: "service owner はまだ決まっていません。",
          self: "このマシンが service owner です",
          hint: "owner は期限切れになりません。旧マシンの service 停止を確認してから引き継いでください。",
          takeOver: "このマシンへ引き継ぐ",
          connection: {
            unknown: "接続状態不明",
            online: "旧 owner はオンラインです",
            delayed: "旧 owner の更新が遅延しています",
            expired: "旧 owner はオフラインです",
          },
          confirmTitle: "service 引き継ぎの確認",
          confirmBody: "現在の owner は {{current}}（{{status}}）です。",
          confirmWarning: "service が二重に動く危険があります",
          confirmHint: "続行する前に、旧マシンの service が停止したことを直接確認してください。",
          cancel: "キャンセル",
          confirmAction: "確認済み。引き継ぐ",
          failed: "service owner を読み取れませんでした",
        },
        sshKey: {
