    ...
    translation: {
      ...
      diagnostics: {
        ...
        executions: {
          title: "Executions",
          description:
            "Pick an execution (manual command, patrol cycle, chat message, diagnostics) and follow its events, logs and prompt traces on one timeline.",
          search: "Search",
      ...
      setup: {
        ...
        intelligence: {
          ...
          skillStatusMessages: {
            ...
            agent_home_missing: "The skill directory for this CLI agent has not been detected.",
    ...
    translation: {
      ...
      setup: {
        ...
        intelligence: {
          ...
          skillStatusMessages: {
            ...
            agent_home_missing: "このCLIエージェントのスキル配置先はまだ検出されていません。",
      ...
      diagnostics: {
        ...
        executions: {
          title: "実行履歴",
          description:
            "実行単位（手動コマンド / 巡回サイクル / チャット受信 / 診断）を選ぶと、関連イベント・ログ・プロンプトトレースを1つのタイムラインで追えます。",
          search: "検索",
