...
build took about 25 s and 1.3 GB before GuildBotics' own Python environment
was added and about 35 s and 1.8 GB after (macOS, base image already pulled,
space used by the writable layer `upper.ext4`).
