...
コマンド、サブコマンド、引数、オプションの一覧は、Click 定義から生成される
[`docs/cli_reference.md`](docs/cli_reference.md) を参照します。CLI 定義を変更した場合は
`uv run --no-sync python scripts/generate-cli-reference.py` で再生成します。
